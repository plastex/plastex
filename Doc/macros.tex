...
is set, or the package is white-listed in the \longprogramopt{tex-packages}
option (see Section\ref{sec:general-options}).
...
Section\ref{sec:general-options}), in the reversed order they are listed
