...
\longprogramopt{lang-terms} take in a variable number of arguments. If this is
the last option supplied, you would have to separate the filename from the list
of arguments, e.g.
\begin{verbatim}
...
That is, in options whose value is a string (or a list of string), we replace
...
or a path to the directory of a renderer.
\end{configuration}
